...
<head>
    ...
    <title>Gym Membership Booking Form</title>
    <style>
        body {
...
<div class="container">
    <form action="save" method="post"  onsubmit="return validateForm()">
        ...
        <input type="text" id="name" name="fullName" placeholder="Enter fullName"  required>
        <span id="outputName"></span><br>

        <label for="age">Age:</label>
        <input type="number" id="age" name="age" placeholder="Enter age" onChange="displayRoomType()" required>
        <span id="outputEmail"></span><br>



      <label for="gen"> Gender:</label>
        <input type="text" id="gender" name="gender" placeholder="Enter fullName"  required>
